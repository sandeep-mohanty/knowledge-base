...
I did have to remove a bunch of error checks and logging lines from that code, or it would be too long for this article, but [this week’s source code download](https://patreon.com/juliocasal) includes the complete version.
